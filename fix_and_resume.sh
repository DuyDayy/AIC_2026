...
for v in $MISSING; do
    echo "Downloading $v"
    modal volume get --force aic-frame-vol /runs/l21-l25-prod-v1/candidates/$v export_for_fusion/l21-l25-prod-v1/candidates/$v
    modal volume get --force aic-frame-vol /runs/l21-l25-prod-v1/vectors/$v export_for_fusion/l21-l25-prod-v1/vectors/$v
done
