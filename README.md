...
512 bằng hoặc hơn 1024 trên mọi chỉ số tổng hợp. 128 thì sập — đáy nằm giữa 256 và 128,
không phải "càng nhỏ càng tốt".

**Kiểm lại đầu-cuối, chấm chuẩn BTC trên 100 câu gán nhãn tay.** Bảng trên đo ở tầng thị
giác trần; đây là A/B sạch qua đủ dung hợp + rổ + ⑤c + rải, chỉ khác đúng tham số `dim`:

| `L` | 512 | 1024 | Δ | KTC95 | thắng/thua |
|---|---|---|---|---|---|
| 9 | 0,4847 | 0,4826 | −0,0021 | [−0,0086, +0,0027] | 2/2 — |
| **11** | 0,5081 | 0,5058 | −0,0023 | [−0,0089, +0,0030] | 2/2 — |
| 21 | 0,5703 | 0,5679 | −0,0024 | [−0,0104, +0,0043] | 2/3 — |
| 51 | 0,6458 | 0,6430 | −0,0028 | [−0,0146, +0,0079] | 2/3 — |

**Không phân biệt được ở mọi `L`** — KTC95 chứa 0 cả bốn mức, và chỉ **4–5 câu trong 100**
đổi kết quả. Rổ ứng viên hai bên **giống hệt** (trung vị 156 khung), nên khác biệt duy
nhất nằm ở thứ tự trong rổ, và ngay cả thứ tự cũng gần như không đổi.

🔴 **Lý lẽ "512 nhanh gấp đôi" SAI trong đường ống đầy đủ.** `②③ chấm 4 nguồn` mất **152s
ở 1024 so với 141s ở 512** — chỉ **+8%**. Con số 11ms/6ms ở bảng trên đo trên **tra vector
thuần**; trong đường ống thật thì **BM25 của ba nguồn văn bản mới là phần tốn**, và chỉ
nguồn thị giác co giãn theo chiều.

Vẫn giữ 512, nhưng **vì lý do khác**: nó tương đương về điểm và tốn **nửa bộ nhớ**
(0,36 GB so với 0,71 GB) — với máy đã OOM nhiều lần thì đó mới là lý lẽ thật.

⚠️ Bộ đo này có **81% câu cần OCR/ASR**, mà chiều vector **chỉ ảnh hưởng nguồn thị giác**.
Ba nguồn văn bản pha loãng tác động. Nhưng ngay cả ở tầng thị giác trần (bảng trên) 1024
cũng không hơn, nên hai phép đo đồng thuận.
